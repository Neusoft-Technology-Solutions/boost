...
#if !(defined(__HP_aCC) && defined(_ILP32) && !defined(_STATVFS_ACPP_PROBLEMS_FIXED)) && !(defined(__ANDROID__))
#define _FILE_OFFSET_BITS 64 // at worst, these defines may have no effect,
#endif
#if defined(__ANDROID__)
   #if (__ANDROID_API__ < 24)
      // Android support for this is not harmless for Android with API level <24 as 64-bit off_t support is broken there.
   #else
